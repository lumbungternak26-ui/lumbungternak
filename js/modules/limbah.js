...
const LimbahModule = {
    ...
    render() {
        ...
        const cfg = Store.getPengaturan ? Store.getPengaturan() : {};
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <span class="text-[11px] text-amber-600 font-semibold">Rata-rata ~${cfg.rataRataKoheHarianKg || 91} kg/hari</span>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-sm flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <span class="text-[11px] text-purple-600 font-semibold">Total kapasitas ${cfg.totalKapasitasLimbahTon || 5.1} Ton / L</span>
                        </div>
                    </div>
