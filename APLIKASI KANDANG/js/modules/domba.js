...
const DombaModule = {
                                    ...
                                    ${list.map(d => {
                                        ...
                                        return `
                                            <tr class="hover:bg-slate-50/70 dark:hover:bg-slate-900/30 transition">
                                                ...
                                                <td class="py-3 px-4 text-right font-bold text-emerald-600 dark:text-emerald-400">${latestWeight} kg</td>
            ...
            <div class="p-6 space-y-4">
                ...
                <form onsubmit="DombaModule.submitTambah(event)" class="space-y-4 text-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <div>
                            <label class="block font-semibold text-slate-700 dark:text-slate-300 mb-1">Bobot Awal Masuk (kg) *</label>
                            <input type="number" step="0.1" id="add-bobot" required placeholder="Contoh: 25.5" class="w-full p-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900">
                        </div>
                        <div>
    ...
    submitTambah(e) {
        ...
        const newDomba = {
            ...
            foto,
            adg: 0,
            riwayatTimbang: [{ tgl: new Date().toISOString().split("T")[0], bobot: bobotAwal, catatan: "Bobot awal pendaftaran" }],
            rekamMedis: [],
            riwayatKawin: []
        };
            ...
            <div class="p-6 space-y-5 max-h-[85vh] overflow-y-auto">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs bg-slate-50 dark:bg-slate-900/50 p-3.5 rounded-xl border border-slate-200/80 dark:border-slate-700/80">
                    ...
                    <div>
                        ...
                        <b class="text-slate-700 dark:text-slate-300">Rp ${d.hargaBeli.toLocaleString('id-ID')}</b>
                    </div>
                </div>
    ...
    submitEditDomba(e, dombaId) {
        ...
        const foto = document.getElementById("edit-foto").value.trim() || "https://images.unsplash.com/photo-1516467508483-a7212febe31a?w=400&auto=format&fit=crop&q=60";
