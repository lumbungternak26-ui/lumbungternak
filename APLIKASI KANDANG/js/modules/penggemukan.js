...
const PenggemukanModule = {
    ...
    downloadTemplateExcel() {
        const headers = ["Eartag", "WarnaEartag", "Nama", "Ras", "AsalTernak", "Kelamin", "Kategori", "Kandang", "Sekat", "BobotAwal", "HargaBeli", "Status"];
        const rows = [
            ["DMB-099", "Kuning", "Bima Super", "Dorper Cross", "Pasar Hewan Imogiri", "Jantan", "Fattening", "Kandang A", "Sekat 05", "30.5", "3000000", "Sehat"],
            ["DMB-100", "Hijau", "Dewi Kunti", "Texel Wonosobo", "Peternak Rakyat Pleret", "Betina", "Indukan", "Kandang B", "Sekat 05", "32.0", "3200000", "Sehat"],
            ["DMB-101", "Merah", "Gatot Subroto", "Garut Tangkas", "Peternak Bantul", "Jantan", "Pejantan", "Kandang A", "Sekat 06", "42.0", "4200000", "Sehat"]
        ];
    ...
    downloadTemplateCSVSemicolon() {
        const header = "Eartag;WarnaEartag;Nama;Ras;AsalTernak;Kelamin;Kategori;Kandang;Sekat;BobotAwal;HargaBeli;Status\r\n";
        const sample1 = "DMB-099;Kuning;Bima Super;Dorper Cross;Pasar Hewan Imogiri;Jantan;Fattening;Kandang A;Sekat 05;30.5;3000000;Sehat\r\n";
        const sample2 = "DMB-100;Hijau;Dewi Kunti;Texel Wonosobo;Peternak Rakyat Pleret;Betina;Indukan;Kandang B;Sekat 05;32.0;3200000;Sehat\r\n";
    ...
    confirmImportData() {
        ...
        this.pendingImportData.forEach((row, idx) => {
            const newD = {
                ...
                riwayatTimbang: [{ tgl: now, bobot: row.bobotAwal, catatan: "Import Berkas Spreadsheet" }],
                rekamMedis: [],
                riwayatKawin: []
            };
